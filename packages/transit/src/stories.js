...
var ONLY_SUBWAY = { bus_multiplier: -1, rail_multiplier: 1 };
var NO_PREFERENCE = { bus_multiplier: 1, rail_multiplier: 1 };
var WBURG_POINT = { lat: 40.71890258024803, lng: -73.9559329152832 };
var FT_GREENE_POINT = { lat: 40.687772, lng: -73.978498 };
var RIDGEWOOD_POINT = { lat: 40.703548367250455, lng: -73.90546447045898 };
...
var stories = {
    ...
    noTransfers: {
        mode: 'single',
        origin: RIDGEWOOD_POINT,
        options: __assign({ max_number_of_transfers: 0 }, ONLY_SUBWAY),
        center: { lat: 40.72382748514871, lng: -73.9781213544922 },
        zoomLevel: 12,
        dest: {
    ...
    lifeWithoutL: {
        ...
        mode: 'compare-settings',
        options2: ONLY_SUBWAY,
        options: __assign({}, ONLY_SUBWAY, { exclude_stops: ['L06', 'L05', 'L03', 'L02', 'L01'] }),
        dest: {
